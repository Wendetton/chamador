      ...
      <div className="bg-white p-6 rounded shadow-md mb-6">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <input
            ...
            className="border border-gray-300 rounded px-4 py-2 flex-1 placeholder-black text-black"
          />
          <input
            type="text"
            placeholder="Sala"
            ...
            className="border border-gray-300 rounded px-4 py-2 w-32 placeholder-black text-black"
          />
          <button
            onClick={handleCall}
          ...
          <ul className="space-y-2 max-h-80 overflow-y-auto">
            {[...documentData.history].reverse().map((chamada, index) => (
              <li key={index} className="border p-3 rounded">
                <p className="font-medium text-black">{chamada.nome} - Sala {chamada.sala}</p>
                <p className="text-xs text-black">{calcularTempo(chamada.chamadoEm)}</p>
              </li>
            ))}
          </ul>
        ) : (
